...
type CalendarWeekNumberProps = React.ComponentProps<"td"> & {
		...
		<DayPicker
			...
			classNames={{
				...
				button_previous: cn(
					...
					"size-[--cell-size] select-none p-0 aria-disabled:opacity-50 shrink-0 flex items-center justify-center aspect-square",

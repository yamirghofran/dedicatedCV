...
function DropdownMenuContent({
	...
	return (
		<DropdownMenuContentPrimitive
			...
			className={cn(
				"bg-popover text-popover-foreground z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-none outline-none",
				className,
			)}
			{...props}
		>
...
function DropdownMenuSubContent({
	...
	return (
		<DropdownMenuSubContentPrimitive
			className={cn(
				"bg-popover text-popover-foreground z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md border p-1 shadow-none outline-none",
				className,
			)}
			{...props}
		/>

...
function CVExportPlaceholder() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      console.error(err)
      const message =
        err instanceof Error ? err.message : 'Please try again after ensuring html2canvas/jspdf are installed.'
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>The exported PDF matches this view.</CardDescription>
          </CardHeader>
          <CardContent>
            <div
              ref={previewRef}
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Classic, modern, and minimal options.</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {[
                ...
                >
                  <input
                    ...
                    className="h-4 w-4"
                    onChange={() => setSelectedFormat(option.id as 'pdf' | 'docx' | 'txt')}
                  />
          ...
          <Button className="gap-2 w-full" onClick={handleExport} disabled={isExporting}>

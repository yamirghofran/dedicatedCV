    ...
    <div className="max-w-2xl space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Strength meter and validation will be added.</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Device list and remote logout will appear here.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="rounded-lg border px-3 py-2 text-sm text-muted-foreground">
            Current session — placeholder device info
          </div>
          <Button variant="outline" disabled>Log out all devices (soon)</Button>
        </CardContent>
      </Card>
    </div>
  )
